...
<?php echo $form->field($model, 'category_name_i', ['template' => '{label}<div class="col-md-9 col-sm-9 col-xs-12 col-12">{input}{error}</div>'])
	->textInput(['maxlength' => true])
	->label($model->getAttributeLabel('category_name_i'), ['class'=>'control-label col-md-3 col-sm-3 col-xs-12 col-12']); ?>

<?php echo $form->field($model, 'category_desc_i', ['template' => '{label}<div class="col-md-9 col-sm-9 col-xs-12 col-12">{input}{error}</div>'])
...
<?php echo $form->field($model, 'rate_status', ['template' => '{label}<div class="col-md-9 col-sm-9 col-xs-12 col-12 checkbox">{input}{error}</div>'])
	->checkbox(['label'=>''])
